...
function doLimitBreakReward(player, Reward, tradeFlag)
    ...
    local aug_3 = 0;
    local val_3 = 0;
    -- These augments are mJob specific per item, not random.
